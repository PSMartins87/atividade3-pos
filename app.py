...
# Adicione esta linha:
st.markdown("---") # Cria uma linha divisória para organizar
st.caption("Fonte dos dados: Secretaria da Fazenda do Paraná (SEFA-PR) - [Histórico de Valores Arrecadados](https://www.fazenda.pr.gov.br/webservices/documentador/Valores-Arrecadados-Historico)")
...
with col3:
    st.subheader("Total Arrecadado por Grupo")
